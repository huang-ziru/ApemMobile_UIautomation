...
#     # click cancel
#     cancel = browser.find_element_by_xpath("//button[@id='INSTRUCTION.cmpFooter.btnCancel']")
...
#     browser.find_element_by_xpath("//input[@id='INSTRUCTION.cmpFooter.txtUserId']").click()
#     browser.find_element_by_xpath("//input[@id='INSTRUCTION.cmpFooter.txtUserId']").send_keys("corp\\qaone")
#     browser.find_element_by_xpath("//input[@id='INSTRUCTION.cmpFooter.pwdSignature']").click()
#     browser.find_element_by_xpath("//input[@id='INSTRUCTION.cmpFooter.pwdSignature']").send_keys("Aspen111")
#     browser.find_element_by_xpath("//input[@id='INSTRUCTION.cmpFooter.pwdSignature']").send_keys(Keys.ENTER)
#     time.sleep(10)
#     assert 'tracking' in browser.current_url
