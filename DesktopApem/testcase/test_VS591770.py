...
class Testtitle_bar():
    ...
    def test_select(self, browser):
        ...
        time.sleep(2)
        browser.find_elements(By.CSS_SELECTOR, "div[class ~= 'order-with-param']")[0].click()
        time.sleep(2)
        ...
        browser.find_element(By.CSS_SELECTOR, "div.ng-star-inserted").find_element(By.TAG_NAME, "input").send_keys('2')
