...
def test_bing(browser):
    ...
    time.sleep(4)
    browser.find_element(By.XPATH, "//*[@id='tracking-content']/app-tracking-list/div/div[2]/table/tbody/tr/td[11]/div/div/div/a/mat-icon").click()
    # browser.find_element(By.XPATH, "//mat-icon[data-mat-icon-name='phase_state_enabled']").click()
    time.sleep(50)
    browser.get_screenshot_as_file(r"..\\report\\result_picture\\"+get_caseID()+"GO_bing.png")
