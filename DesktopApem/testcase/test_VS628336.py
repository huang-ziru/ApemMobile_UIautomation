...
def test_Breadcrumb(browser):
    ...
    phasename = browser.find_element_by_xpath("/html/body/app-root/div/app-execution/div/div[1]/div").text
    ...
    for phase in phase_list:
        if phase.get_attribute('textContent') == phasename:
            ...
            phase_ele = browser.find_element_by_xpath(state_xpath).find_element_by_css_selector("td[class ~= 'cdk-column-STATUS']")
