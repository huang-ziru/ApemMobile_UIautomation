...
def test_loginuser(browser):
    ...
    browser.get_screenshot_as_file(r"..\\report\\result_picture\\"+get_caseID()+"loginuser.png")
    time.sleep(5)
    assert user_info == browser.find_element(By.XPATH, '//*[@id="logoutpanel"]/button[1]/span').text
def test_logout(browser):
    MainPage(browser).logout()
    time.sleep(3)
    browser.get_screenshot_as_file(r"..\\report\\result_picture\\"+get_caseID()+"logout.png")
